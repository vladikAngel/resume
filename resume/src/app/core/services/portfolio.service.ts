  ...
  getProjects(language: string = 'En'): Observable<Array<IProject>> {
    ...
    if (language === 'En') {
      projects = [
        ...
        {
          id: 3,
          title: 'Unified System of Identification and Authentication (USIA)',
          ...
          instruments: ['Angular 16', 'HTML', 'SCSS', 'RXJS', 'TS', 'Bootstrap']
        },
      ];
    } else if (language === 'Ru') {
      projects = [
        ...
        },
        {
          ...
          instruments: ['Angular 16', 'Angular Universal (SSR)', 'HTML', 'SCSS', 'RXJS', 'TS', 'Material', 'Bootstrap']
        },
        {
          id: 2,
          ...
          instruments: ['Angular 16-17', 'HTML', 'SCSS', 'RXJS', 'TS', 'Bootstrap']
        },
        {
          id: 3,
